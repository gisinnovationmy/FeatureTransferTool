...
class FeatureTransferDockWidget(QtWidgets.QDockWidget, FORM_CLASS):
    ...
    def __init__(self, parent=None):
        ...
        self.Copy_from_Layer.setFilters(QgsMapLayerProxyModel.Filter.VectorLayer)
        self.Paste_to_Layer.setFilters(QgsMapLayerProxyModel.Filter.VectorLayer)
    ...
    def setDefaultLayer(self):
        ...
        visible_vector_layers = [
            ...
            if isinstance(node.layer(), QgsVectorLayer) and node.isVisible()
        ]
