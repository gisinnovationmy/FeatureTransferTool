...
class FeatureTransfer:
    ...
    def toggle_panel(self, checked):
        ...
        if checked:
            # Show the dock widget if the action is checked
            if self.dockwidget:
                self.dockwidget.show()
        else:
            # Hide the dock widget if the action is unchecked
            if self.dockwidget:
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            #print "** STARTING FeatureTransfer"
